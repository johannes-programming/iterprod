...
test: beautiful dist
	...
	conda run -n test_iterprod pip install dist/*.tar.gz >/dev/null;
	conda run -n test_iterprod python run_tests.py;
	conda run -n test_iterprod pip install mypy >/dev/null;
	conda run -n test_iterprod python -m mypy --exclude build --exclude dist --strict .;
